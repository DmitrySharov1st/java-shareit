...
class ItemServiceTest {
    ...
    void setUp() {
        ...
        itemRequest = ItemRequest.builder()
                ...
                .requestor(User.builder().id(3L).name("Requester").email("req@test.com").build())
                .created(LocalDateTime.now())
                .build();
    }
    ...
    @Test
    void createItem_WithValidRequestId_ShouldCreateItem() {
    ...
    @Test
    void createItem_WithOwnRequestId_ShouldThrowValidationException() {
        ...
        itemDto.setRequestId(10L);
        when(userRepository.findById(1L)).thenReturn(Optional.of(owner));
        when(requestRepository.findById(10L)).thenReturn(Optional.of(ownRequest));
